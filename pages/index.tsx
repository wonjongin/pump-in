...
export default function Home() {
  const sites = [
    ...
    { name: "회사링크들", path: "/products/links" },
  ];
  return (
        ...
        <div className="backdrop-blur-sm backdrop-brightness-75 bg-black/25 p-8 md:p-12 lg:px-16 lg:py-24">
          <div className="max-w-lg md:max-w-none text-center sm:text-left">
            ...
            <p className="text-justify max-w-md text-white/90 md:mt-6 md:block md:text-lg md:leading-relaxed md:text-center">
              저희 홈페이지를 방문하신 고객 여러분 진심으로 환영합니다. 또한
              귀사의 무궁한 발전과 번영을 기원합니다. 저희 펌프모터시스템 창 은
              산업용 펌프, 모터를 취급, 생산하는 회사로서 급수부스터펌프시스템을
              비롯하여 소방, 순환, 오.배수, 볼텍스, 진공 펌프 등을 취급 판매 및
              수리하고 있습니다. 항상 고객의 입장에서 고객의 마음으로 최선을
              다하여 모시겠습니다. 기술자문을 필요로 하시는 분들은 어려워 마시고
              연락을 주시면 언제든지 신속하게 답변해 드리겠습니다. 고객의 만족을
              위하여 최선을 다하는 인창피엠티가 되겠습니다.
              <br />
              <br />
              <div className="text-right">
                <span className="text-2xl">인창피엠티</span> 임직원 일동
              </div>
            </p>
